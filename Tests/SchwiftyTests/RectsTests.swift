...
class RectInsetsTests: XCTestCase {
    func testCanShrinkRectViaSingleValueInset() {
        ...
        XCTAssertEqual(enlarged.minX, 12)
        XCTAssertEqual(enlarged.minY, 12)
    ...
    func testCanGrowRectViaSingleValueInset() {
        ...
        XCTAssertEqual(enlarged.minY, 8)
        XCTAssertEqual(enlarged.width, 14)
        XCTAssertEqual(enlarged.height, 14)
    }
}
